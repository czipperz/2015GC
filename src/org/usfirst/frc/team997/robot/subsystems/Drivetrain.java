...
public class Drivetrain extends Subsystem {
	...
	public Drivetrain(
		...
		leftAccelMotor = new AccelMotor(new VelMotor(leftMotor, leftEnc, driveVelCal, "left"), maxAccelDrive, "left");
		rightAccelMotor = new AccelMotor(new VelMotor(rightMotor, rightEnc, driveVelCal, "right"), maxAccelDrive, "right");
		
		shiftSolenoid = new DoubleSolenoid(RobotMap.ShifterSolenoidLow, RobotMap.ShifterSolenoidHigh);
	...
	public void SmartDashboard() {
		...
		SmartDashboard.putNumber("Left Drive Encoder", this.leftEnc.getDistance());
		SmartDashboard.putNumber("Right Drive Encoder", this.rightEnc.getDistance());
		SmartDashboard.putNumber("Left Drive rate Encoder", this.leftEnc.getRate());
		SmartDashboard.putNumber("Right Drive rate Encoder", this.rightEnc.getRate());
